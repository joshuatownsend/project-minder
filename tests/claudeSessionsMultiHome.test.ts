...
vi.mock("fs", () => ({
  promises: {
    ...
    // by OPENING it, not by asking whether the path exists (Codex P2, #510).
    ...
    // about. Resolving = the home is there and listable.
    opendir: vi.fn().mockResolvedValue({ close: async () => {} }),
  },
}));
