...
const state = installIsolatedState({ prefix: "pm-data-list-", extraGlobals: ["__usageCache", "__usageFileCache", "__sessionIndex", "__sessionsCache"], preserveEnv: ["MINDER_USE_DB"] });
