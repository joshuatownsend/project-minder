...
describe("runLintEngine (Wave A — adapter only)", () => {
  ...
  it("returns empty findings for a zero-finding audit", async () => {
    ...
    const report = await runLintEngine({ claudeMdAudit: clean });
