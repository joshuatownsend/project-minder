...
// Normalises an OTLP attribute list into a Map. The same logical attribute can
...
// wire form serialises back into payload_json as a quoted JSON string, while
// intValue/doubleValue serialise as unquoted JSON numbers. Consumers querying
